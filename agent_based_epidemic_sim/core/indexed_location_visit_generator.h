...
#ifndef THIRD_PARTY_AGENT_BASED_EPIDEMIC_SIM_CORE_INDEXED_LOCATION_VISIT_GENERATOR_H_
#define THIRD_PARTY_AGENT_BASED_EPIDEMIC_SIM_CORE_INDEXED_LOCATION_VISIT_GENERATOR_H_
