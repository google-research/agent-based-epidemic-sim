...
#define PANDEMIC_INTERNAL_HAS_KEYWORD(x) !(__is_identifier(x))
#else
#define PANDEMIC_INTERNAL_HAS_KEYWORD(x) 0
#endif

#if !defined(PANDEMIC_INTERNAL_HAVE_SOURCE_LOCATION_CURRENT)
#if PANDEMIC_INTERNAL_HAS_KEYWORD(__builtin_LINE) && \
    PANDEMIC_INTERNAL_HAS_KEYWORD(__builtin_FILE)
#define PANDEMIC_INTERNAL_HAVE_SOURCE_LOCATION_CURRENT 1
#else
#define PANDEMIC_INTERNAL_HAVE_SOURCE_LOCATION_CURRENT 0
#endif
#endif
