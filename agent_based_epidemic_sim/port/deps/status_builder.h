...
#include "agent_based_epidemic_sim/port/deps/status_payload.h"
...
//
//   StatusBuilder builder(original, PANDEMIC_LOC);
...
//
//   return StatusBuilder(original, PANDEMIC_LOC)
...
class ABSL_MUST_USE_RESULT StatusBuilder {
 public:
  ...
  // copybara:strip_end
  // This override allows us to implement PANDEMIC_RETURN_IF_ERROR with 2 move
