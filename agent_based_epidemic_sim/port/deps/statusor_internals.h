...
#ifndef AGENT_BASED_EPIDEMIC_SIM_PORT_DEPS_STATUSOR_INTERNALS_H_
#define AGENT_BASED_EPIDEMIC_SIM_PORT_DEPS_STATUSOR_INTERNALS_H_
...
#endif  // AGENT_BASED_EPIDEMIC_SIM_PORT_DEPS_STATUSOR_INTERNALS_H_
